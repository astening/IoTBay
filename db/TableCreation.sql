...
('2023-01-01', 'Shipped', 3, 179.97, 1),
('2023-01-02', 'Pending', 2, 299.98, 2),
('2023-01-03', 'Delivered', 1, 129.99, 3),
('2023-01-04', 'Shipped', 1, 99.99, 4),
('2023-01-05', 'Pending', 2, 399.98, 5),
('2023-01-06', 'Delivered', 3, 599.97, 6),
('2023-01-07', 'Shipped', 1, 49.99, 7),
('2023-01-08', 'Pending', 2, 159.98, 8),
('2023-01-09', 'Delivered', 1, 499.99, 9),
('2023-01-10', 'Shipped', 3, 599.97, 10),
('2023-01-11', 'Pending', 2, 179.98, 11),
('2023-01-12', 'Delivered', 1, 299.99, 12),
('2023-01-13', 'Shipped', 1, 199.99, 13),
('2023-01-14', 'Pending', 2, 399.98, 14),
('2023-01-15', 'Delivered', 3, 699.97, 15),
('2023-01-16', 'Shipped', 1, 99.99, 16),
('2023-01-17', 'Pending', 2, 259.98, 17),
('2023-01-18', 'Delivered', 1, 399.99, 18),
('2023-01-19', 'Shipped', 3, 699.97, 19),
('2023-01-20', 'Pending', 2, 159.98, 20),
('2023-01-21', 'Delivered', 1, 299.99, 21),
('2023-01-22', 'Shipped', 1, 199.99, 22),
('2023-01-23', 'Pending', 2, 399.98, 23),
('2023-01-24', 'Delivered', 3, 599.97, 24),
('2023-01-25', 'Shipped', 1, 99.99, 25);
...
(1, 'John Doe', '1234567812345678', '2025-01-01', 123),
(2, 'Jane Smith', '2345678923456789', '2025-02-01', 234),
(3, 'Michael Johnson', '3456789034567890', '2025-03-01', 345),
(4, 'Emily Davis', '4567890145678901', '2025-04-01', 456),
(5, 'Daniel Miller', '5678901256789012', '2025-05-01', 567),
(6, 'Sophia Garcia', '6789012367890123', '2025-06-01', 678),
(7, 'James Martinez', '7890123478901234', '2025-07-01', 789),
(8, 'Isabella Brown', '8901234589012345', '2025-08-01', 890),
(9, 'William Jones', '9012345690123456', '2025-09-01', 901),
(10, 'Olivia Wilson', '0123456701234567', '2025-10-01', 123),
(11, 'Lucas Moore', '1234567812345678', '2025-11-01', 234),
(12, 'Mia Taylor', '2345678923456789', '2025-12-01', 345),
(13, 'Ethan Anderson', '3456789034567890', '2025-01-01', 456),
(14, 'Ava Thomas', '4567890145678901', '2025-02-01', 567),
(15, 'Mason Jackson', '5678901256789012', '2025-03-01', 678),
(16, 'Charlotte White', '6789012367890123', '2025-04-01', 789),
(17, 'Elijah Harris', '7890123478901234', '2025-05-01', 890),
(18, 'Amelia Martin', '8901234589012345', '2025-06-01', 901),
(19, 'Logan Lee', '9012345690123456', '2025-07-01', 123),
(20, 'Evelyn Perez', '0123456701234567', '2025-08-01', 234),
(21, 'Alexander Thompson', '1234567812345678', '2025-09-01', 345),
(22, 'Harper King', '2345678923456789', '2025-10-01', 456),
(23, 'Henry Wright', '3456789034567890', '2025-11-01', 567),
(24, 'Avery Scott', '4567890145678901', '2025-12-01', 678),
(25, 'Liam Green', '5678901256789012', '2025-01-01', 789);

INSERT INTO Payment (userID, orderID, paymentDate, paymentAmount) VALUES
(1, 1, '2023-01-01', 299.99),
(2, 2, '2023-01-03', 199.99),
(3, 3, '2023-01-05', 99.99),
(4, 4, '2023-01-07', 399.99),
(5, 5, '2023-01-09', 149.99),
(6, 6, '2023-01-11', 249.99),
(7, 7, '2023-01-13', 499.99),
(8, 8, '2023-01-15', 59.99),
(9, 9, '2023-01-17', 119.99),
(10, 10, '2023-01-19', 349.99),
(11, 11, '2023-01-21', 299.99),
(12, 12, '2023-01-23', 49.99),
(13, 13, '2023-01-25', 179.99),
(14, 14, '2023-01-27', 599.99),
(15, 15, '2023-01-29', 199.99),
(16, 16, '2023-02-01', 149.99),
(17, 17, '2023-02-03', 399.99),
(18, 18, '2023-02-05', 299.99),
(19, 19, '2023-02-07', 99.99),
(20, 20, '2023-02-09', 199.99),
(21, 21, '2023-02-11', 349.99),
(22, 22, '2023-02-13', 499.99),
(23, 23, '2023-02-15', 59.99),
(24, 24, '2023-02-17', 119.99),
(25, 25, '2023-02-19', 349.99);
