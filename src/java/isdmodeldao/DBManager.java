...
public class DBManager {
    ...
    // add the order in the database - few changes to be made with PK and date
    // double check input is so you dont always need the useriD
    // manually insert orderID with autogenerated in statement ? how?
    public void addOrder(int orderID, int noItems, int userID, int productID) throws SQLException { // 
